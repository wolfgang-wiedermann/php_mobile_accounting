<?php defined("MAIN_PAGE") or die("Fehlende Berechtigung, Seite darf nur aus index.php geladen werden"); ?>
        ...
        <ul data-role="listview" data-filter="true" data-filter-placeholder="Search Item..." data-theme="d">
            <li data-role="list-divider">Quick ones</li>
            <li><a href="#" id="menu_quick_tanken">Tanken</a></li>
            <li><a href="#" id="menu_quick_lebensm">Lebensmittel</a></li>
            <li><a href="#" id="menu_quick_luxus">Luxus</a></li>
