<div data-role="page" id="ergebnis_menue">
  ...
  <div data-role="content">
    <ul data-role="listview" data-filter="false">
      ...
      <li><a data-bind="click: ergebnis().bilanz, text:i18n.ergebnis.bilanz" href="#ergebnis_view"></a></li>
      <li><a data-bind="click: ergebnis().guvjahr, text:i18n.ergebnis.guvjahr" href="#ergebnis_view"></a></li>
      <li><a data-bind="click: ergebnis().guvmonat, text:i18n.ergebnis.guvmonat" href="#ergebnis_view"></a></li>
      <li><a data-bind="click: ergebnis().guvprognose, text:i18n.ergebnis.guvprognose" href="#ergebnis_view"></a></li>
      <li data-role="list-divider" data-bind="text:i18n.verlauf.verlaufsauswertungen"></li>
      <li><a data-bind="click: verlauf().verlaufaufwand, text:i18n.verlauf.verlaufaufwand" href="#ergebnis_view"></a></li>
