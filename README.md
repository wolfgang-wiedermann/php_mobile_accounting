...
On the serverside its code relies just on plain PHP5 or PHP7 (currently using mysqli for 
database connectivity - will be step by step ported to PDO) with no additional frameworks.
